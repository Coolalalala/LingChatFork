  ...
  <div class="flex w-full flex-col gap-4">
    ...
    <MenuItem :title="t('scriptEditor.agentSettings.llmModel')">
      ...
      <div class="flex flex-col gap-3">
        <div>
          <label class="text-brand mb-1.5 inline-flex items-center text-[0.9rem] font-medium">{{
            t("scriptEditor.agentSettings.model")
          }}</label>
          <select v-model="providerId" class="glass-input w-full py-2" @change="applyProvider">
          ...
          <p
            class="mt-1 text-[0.72rem] text-white/40"
    ...
    <MenuItem :title="t('scriptEditor.agentSettings.security')">
      ...
      <div class="flex flex-col gap-4">
        ...
        <p
          class="-mt-2 text-[0.72rem] text-white/40"
          v-html="
            android
        ...
        <div class="rounded-lg border border-white/10 bg-black/20 px-3 py-2.5">
          <div class="mb-1 text-[0.72rem] text-white/45">
          ...
          <p
            class="mt-1 text-[0.68rem] text-white/35"
    ...
    <MenuItem :title="t('scriptEditor.agentSettings.runtime')">
      ...
      <div class="flex flex-col gap-4">
        <div class="flex items-center gap-3">
          <label class="shrink-0 text-[0.86rem] text-white/75">{{
          ...
          />
          <span class="text-[0.72rem] text-white/40">{{
      ...
      <div class="flex flex-col gap-2">
        ...
        >
          ...
          <span class="flex min-w-0 flex-1 flex-col">
            ...
            <span class="truncate text-[0.72rem] text-white/45">{{
        ...
        >
          <div class="flex items-center justify-between border-b border-white/10 px-3 py-2">
            <span class="text-brand font-mono text-[0.78rem]">{{ preview.name }} · SKILL.md</span>
            <span class="cursor-pointer text-white/45 hover:text-white/80" @click="preview = null"
              >✕</span
            >
          </div>
          <pre
